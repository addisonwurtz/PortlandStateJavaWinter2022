...
public class TextDumperTest {
  ...
  void InformationForMultipleFlightsIsDumpedInTextFormat() {
    String airlineName = "Delta";
    Airline airline = new Airline(airlineName);
    Flight flight1 = new Flight(12, "PDX", "01/24/2022", "11:11 am", "SFO",
            "01/25/2022", "12:12 pm");
    Flight flight2 = new Flight(13, "LAX", "01/24/2022", "11:11 am", "MSP",
            "01/25/2022", "3:12 pm");
    ...
    assertThat(text, containsString(flight1.getDestination()));
    assertThat(text, containsString(flight2.getDestination()));
  }
}
