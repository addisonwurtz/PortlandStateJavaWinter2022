                ...
                case "depart": {
                    ...
                    for (int j = 0; j < dateNodes.getLength(); j++) {
                        ...
                        switch (dateElement.getNodeName()) {
                            case "date": {
                                day = parseInt(dateElement.getAttribute("day"));
                                month = parseInt(dateElement.getAttribute("month"));
                                year = parseInt(dateElement.getAttribute("year"));
                            }
                            break;
                            case "time": {
                                hour = parseInt(dateElement.getAttribute("hour"));
                                minute = parseInt(dateElement.getAttribute("minute"));
                            }
                            break;
                            default:
                                throw new IllegalStateException("Unexpected value: " + dateElement.getNodeName());
                        }
                    }
